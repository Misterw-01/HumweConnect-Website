<?php                                      
/**
 * Advisory functions and definitions
 *
 * @package Advisory
 */
...
if ( ! function_exists( 'advisory_setup' ) ) :
/**
 ...
 */
function advisory_setup() { 		
	$GLOBALS['content_width'] = apply_filters( 'advisory_content_width', 680 );		
	load_theme_textdomain( 'advisory', get_template_directory() . '/languages' );
...
add_action( 'wp_print_footer_scripts', 'advisory_skip_link_focus_fix' );

//Custom Excerpt length.
function advisory_excerpt_length( $length ) {
    if ( is_admin() ) return $length;
    return 20;
}
add_filter( 'excerpt_length', 'advisory_excerpt_length', 999 );

function advisory_customize_partial_blogname() {
	bloginfo( 'name' );
}

function advisory_customize_partial_blogdescription() {
